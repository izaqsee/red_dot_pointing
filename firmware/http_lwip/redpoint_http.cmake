...
# Include redpoint_http_opts.h from lwipopts.h for RAM reply lifetime safety.
...
function(redpoint_attach_http target)
  ...
  target_include_directories(${target} PRIVATE "${root}/firmware/redpoint" "${root}/firmware/http_lwip" "${generated}")
